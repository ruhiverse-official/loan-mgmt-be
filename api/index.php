...
$routes = [
    ...
    "GET" => [
        ...
        "payments/total/{person_id}/{person_type}/{loanId}" => [$paymentController, 'getTotalPaidAndPendingByPersonId'],
        "payments/list/{person_id}/{person_type}/{loanId}" => [$paymentController, 'getPaymentsByPerson'],
